...
<body onLoad="javascript:print()"> 
							...
							<td><div align="center">
							<div align="center">
                                <b>KLINIK PRATAMA SIMPANG TIGA<br>Jl. Lintas Ophir Barat No.RT.002, Koto Baru, Kec. Luhak Nan Duo, Kabupaten Pasaman Barat, Sumatera Barat.</b><br><hr><br>Laporan Data Pasien<br><?= Date('d F Y'); ?></div>
							 </td>
							</tr>
							</table>
                    </div>
                    ...
                    <tr>
                        ...
                        <td width="50%" bgcolor="#FFFFFF">
                           ...
                           Kepala Pratama Klinik Simpang Tiga
                            <br/><br/>
                            <br/><br/>
                            {{ session('puskesmas') }}
                            </div>
